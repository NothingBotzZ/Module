...
function title() {
    console.log(chalk.bold.green(figlet.textSync('Andriann', {
        font: 'Standard',
    ...
    console.log(chalk.yellow(`\n${chalk.yellow('[ Created By Andriann ]')}\n`))
}
...
const connectToWhatsApp = async () => {
    ...
    nocache('./message/help', module => console.log(chalk.greenBright('[ Didan ]  ') + time + chalk.cyanBright(` "${module}" Updated!`)))
    nocache('./lib/myfunc', module => console.log(chalk.greenBright('[ Didan ]  ') + time + chalk.cyanBright(` "${module}" Updated!`)))
    nocache('./message/kaysa', module => console.log(chalk.greenBright('[ Didan ]  ') + time + chalk.cyanBright(` "${module}" Updated!`)))
